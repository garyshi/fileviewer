...
import { VERBATIM_EXTENSIONS } from './mime.js';

// Extensions rendered through a template (Markdown, JSON, JSONL).
const RENDERED_EXTENSIONS = new Set(['.md', '.json', '.jsonl']);

// Everything the server is willing to list and serve: rendered + verbatim.
const SUPPORTED_EXTENSIONS = new Set([...RENDERED_EXTENSIONS, ...VERBATIM_EXTENSIONS]);
...
export { listDirectory, SUPPORTED_EXTENSIONS, RENDERED_EXTENSIONS };
